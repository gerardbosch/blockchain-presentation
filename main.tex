...
\newcommand{\originaldate}{September 27, 2018}
\date{\originaldate}
...
\end{comment}
    ...
    \begin{frame}
        \begin{center}
            ...
            \vspace{0.8cm}\originaldate \\
            ({\footnotesize Last build: \today})
        \end{center}
    \end{frame}
    %%%%%%%%%%%%%%%%%%%%%% End title %%%%%%%%%%%%%%%%%%%%%%%
        ...
        \begin{overlayarea}{\textwidth}{\textheight}
            ...
            \begin{exampleblock}{Ledger}
                ...
                \begin{columns}[T]
                    ...
                    The \st{foundation of accounting}, are as ancient as writing and money (Mesopotamia $<$ 5000 B.C.).

                    \column{0.3\textwidth}
                    \includegraphics[scale=0.1]{img/papyrus.png}
    ...
    \begin{overlayarea}{\textwidth}{0.9\textheight}
        ...
        \begin{itemize}
            ...
            \pause
            \item Blockchain provides a \textbf{reliable} infrastructure that provides \st{at least} 2 out of the 3 properties of \st{CIA triad}: \alert{integrity} and \alert{availability}.
        \end{itemize}
    ...
    \begin{frame}
        ...
        \begin{overlayarea}{\textwidth}{0.7\textheight}
            ...
            \begin{itemize}
                ...
                \pause
                \item \st{Validation} is required in order to \textbf{append} a new block of transactions to the chain; preventing things such as double spend.
                \pause
    ...
    \begin{frame}
        ...
        \begin{enumerate}
            \itemsep=4ex
            \item Clients \textbf{create} and \alert{sign} transactions (TX) using their private key, then they \st{broadcast} TX to the network.
    ...
    \begin{frame}
        ...
        \begin{overlayarea}{\textwidth}{\textheight}
            ...
            \begin{itemize}
                \itemsep=1ex
                \item Block creation consists in finding a \st{nonce} (number) for the block that \st{satisfies} a property of the block's hash (a number of leading zeros) known as difficulty.
        ...
        \begin{overlayarea}{\textwidth}{0.85\textheight}
            ...
            \begin{exampleblock}{Pros}
                \begin{itemize}
                    ...
                    \item \st{Security}: Purchasing more than half of the coins is likely more costly than acquiring 51\% of PoW hashing power.
                \end{itemize}
            \end{exampleblock}
    ...
    \begin{frame}
        ...
        \visible<1-> {
            \vspace{6ex}
            \begin{center}{\LARGE What is a cryptocurrency?}\end{center}
        }
        ...
        \only<2-3> {
            \begin{block}{Cryptocurrency}
                A \textbf{digital asset} (or currency) that relies on cryptography to work and runs over a decentralized network, \st{typically} backed by a Blockchain.
            \end{block}
            
            \only<2> {
                \vspace{1ex}
                % Ref: https://en.bitcoin.it/wiki/How_bitcoin_works#Cryptography
                \alert{Crypto} in crypto-currency does \textbf{not} mean that all information in the Blockchain is \st{encrypted} and secret\ldots
                \begin{itemize}
                    \item Bitcoin Blockchain is not confidential at all as transaction details are public.
                    \item \ldots But can be \st{challenging} to trace and \alert{relate} transactions.
                \end{itemize}
            }
            
            \only<3> {
                \vspace{1ex}
                \alert{Crypto} comes from the use of cryptographic techniques used by the protocol such as:
                \begin{itemize}
                    \item Public-key (asymmetrical) cryptography
                    \item Cryptographic hashes (e.g. SHA-256 Bitcoin)
                    \item \ldots \sl{(probably more)}
                \end{itemize}
            }
        }
    ...
    \begin{frame}
        ...
        \visible<1-> {
            \vspace{6ex}
            \begin{center}{\LARGE What is a cryptocurrency \st{wallet}?}\end{center}
        }
        
        \vspace{1ex}
        
        \only<2-> {
            \begin{alertblock}{What is \textbf{not} a wallet\ldots}<2->
                A software or physical device where your coins are \textbf{stored inside}.
            \end{alertblock}
            
            \begin{exampleblock}{What is a wallet indeed\ldots}<3->
                The term wallet can refer to 2 things:
                
                \begin{enumerate}
                    \renewcommand{\theenumi}{\Alph{enumi}}
                    \item a \st{software} that allows to interact with a Blockchain (a light client);
                    \item a \st{store} for your addresses and its \alert{private keys};
                \end{enumerate}
    ...
    \begin{frame}
        ...
        \begin{columns}[t]
            ...
            \begin{tabular}{p{0.41\textwidth}l}
                ...
                Brain wallets  & \href{https://keybase.io/warp}{keybase.io/warp} \\
            \end{tabular}
            \end{block}
...
\begin{frame}
    ...
    \vspace{1ex}
    Bitkey is a \st{Linux live} distribution that includes a set of tools and wallets for some of the most popular cryptocurrencies.

    It can run in 2 modes:

    \begin{itemize}
        \item Hot online: Interact with the Blockchain from a secure environment.
        \item Cold offline: This is the most secure way of operating as it starts as an \st{air-gapped} system where private key is \alert{never} exposed.
    \end{itemize}

    As a side project has not received updates in a while, but a recent fork provided by @estevaocm on \href{https://github.com/estevaocm/bitkey}{GitHub} includes many interesting tools such as:

    \begin{itemize}
        \item QR-code scanning through webcam :)  -- A very convenient way to import and export TX and addresses.
        \item Support for several \st{other} cryptocurrency \st{wallets} other than Bitcoin (Ethereum, Litecoin,\ldots) ---more are being constantly added.
    \end{itemize}
...
%--------------------------------End-----------------------------------
    ...
    \subsection{The future will be decentralized}
    %--------------------------------Frame---------------------------------
    \begin{frame}
        ...
        \visible<1-> {
            ...
            Since its creation, Internet has been \textbf{mostly} \st{centralized}\footnote{ARPANET hosts file is a great example.},
            ...
            During the years more distributed and P2P protocols has been deployed, although \st{client-server} model is the most common yet.
        }

        \vspace{1ex}
        \visible<2-> {
            \begin{exampleblock}{}
                \textbf{But} the appearance of new P2P systems can drive Internet to a new state
            \end{exampleblock}
        }
    ...
    \begin{overlayarea}{\textwidth}{0.9\textheight}
        ...
        \end{itemize}
            ...
            \only<2-> {
                \begin{exampleblock}{}
                    Blockchain and Smart Contracts could provide the infrastructure to \textbf{tackle} such a serious problem.
                \end{exampleblock}
            }
        }
        ...
        \only<3> {
                ...
                Percentage of \alert{unbanked} people {\footnotesize (Source: \href{https://ethichub.com}{ethichub.com})}
        }
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \tiny \href{https://blockchain-presentation.gerardbosch.xyz}{blockchain-presentation.gerardbosch.xyz}
