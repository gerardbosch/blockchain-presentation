...
\end{comment}
    ...
    \begin{frame}
        ...
        \begin{overlayarea}{\textwidth}{\textheight}
            ...
            \begin{itemize}
                ...
                \item<7-> The \st{concept} and its implementation was created in 2008/2009 and announced in a 9 pages paper written by Satoshi Nakamoto.
            \end{itemize}
    ...
    \begin{frame}
        ...
        \begin{overlayarea}{\textwidth}{\textheight}
            ...
            \begin{itemize}
                \itemsep=1ex
                \item Block validation consist in finding a \st{nonce} (number) for the block that \st{satisfies} a property of the block's hash (a number of leading zeros).
    ...
    \begin{frame}
        ...
        \begin{exampleblock}{}<2->
            For its nature is usually called digital gold.
        \end{exampleblock}
    ...
    \begin{overlayarea}{\textwidth}{0.9\textheight}
        ...
        \only<2-> {
            \begin{exampleblock}{}
                Blockchain and Smart Contracts could provide the infrastructure to tackle a so serious problem.
            \end{exampleblock}
        }
        }
        ...
        \only<3-> {
            \vspace{0.5ex}
            \centering\includegraphics[scale=0.43]{../img/worlds-nonfinancial-population.png}
        ...
        \begin{columns}
            ...
            \only<1> {
                \begin{itemize}
                    ...
                    \item In near future, it will \alert{potentially provide} Internet access to millions of people that are offline nowadays.
                \end{itemize}
            }
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item \st{Traditional} financial model is becoming out-dated.
            \item But for now, Blockchain ecosystem is probably not yet mature enough to drive world's economy.
            \item Awesome things could happen, but only time will tell.
        \end{itemize}
