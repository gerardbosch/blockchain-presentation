...
\end{comment}
    ...
    \begin{frame}
        ...
        \begin{overlayarea}{\textwidth}{\textheight}
            ...
            \vspace{4ex}
            \begin{itemize}
                \item \alert{Suppress} the necessity trusted third-party (i.e. Financial institutions and Banks).
        ...
        \begin{columns}
            ...
            \column{0.74\textwidth}
                    ...
                    \begin{itemize}\itemsep=0.4ex
                        \item Founded by Vitalik Buterin, a young cryptocurrency researcher/programmer.
                        \item Features a \textbf{TC-complete} programming language called \textbf{Solidity}.
    ...
    \begin{overlayarea}{\textwidth}{0.75\textheight}
        ...
        The third generation of Blockchain is mainly focused to \st{address} two main issues:
        ...
        \only<2-> {
            \begin{block}{Scalability}<2->
                A 3rd generation of Blockchain should be able to scale to several thousands of TPS.\\[1ex]
            ...
            \begin{exampleblock}{Cardano}<4->
                is a 3rd generation Blockchain focused to address limitations with 2nd generation Blockchains.
            \end{exampleblock}
        }
